...
4. **Neuron anchors** — nearest `go.mod` under the neuron build root for the service you are editing; entrypoint in that module (runtime skills: `internal/skills/skills/` relative to that module).
