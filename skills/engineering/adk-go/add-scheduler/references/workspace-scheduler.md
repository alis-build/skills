...
3. **Neuron anchors** — nearest `go.mod` under the neuron build root for the service you are editing.
4. **Ask user** — Smallest missing piece only (which neuron when several exist).
