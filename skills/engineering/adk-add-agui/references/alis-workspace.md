...
4. **Neuron anchors** — nearest `go.mod` under the neuron build root for the service you are editing. For optional Spanner proto work, `tools.proto` under the matching define tree (`workstations.define_repos`).
